...
function M.get(spec, conf)
  ...
  return {
    ...
    DiffAdd = { fg = spec.diff.add, bg = spec.pal.black.base }, -- diff mode: Added line |diff.txt|
    DiffChange = { fg = spec.diff.change, bg = spec.pal.black.base }, -- diff mode: Changed line |diff.txt|
    DiffDelete = { fg = spec.diff.delete, bg = spec.pal.black.base }, -- diff mode: Deleted line |diff.txt|
    DiffText = { fg = spec.diff.text, bg = spec.bg0 }, -- diff mode: Changed text within a changed line |diff.txt|
    ...
    LineNr = { fg = spec.bg4 }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr = { fg = spec.pal.accent.base, style = "bold" }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    Pmenu = { fg = spec.fg2, bg = spec.bg3 }, -- Popup menu: normal item.
    PmenuSel = { fg = spec.bg1, bg = spec.pal.accent.base }, -- Popup menu: selected item.
    ...
    -- Diff
    diffAdded = { fg = spec.diff.add },
    diffRemoved = { fg = spec.diff.delete },
    diffChanged = { fg = spec.diff.change },
